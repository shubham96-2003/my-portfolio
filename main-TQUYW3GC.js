...
`],encapsulation:2,changeDetection:0})}return t})();function $f(t){return t.hasAttribute("mat-raised-button")?"elevated":t.hasAttribute("mat-stroked-button")?"outlined":t.hasAttribute("mat-flat-button")?"filled":t.hasAttribute("mat-button")?"text":null}var Gf=new y("mat-mdc-fab-default-options",{providedIn:"root",factory:()=>Da}),Da={color:"accent"},Ec=(()=>{class t extends ya{_options=c(Gf,{optional:!0});_isFab=!0;extended=!1;constructor(){super(),this._options=this._options||Da,this.color=this._options.color||Da.color}static \u0275fac=function(n){return new(n||t)};static \u0275cmp=x({type:t,selectors:[["button","mat-fab",""],["a","mat-fab",""],["button","matFab",""],["a","matFab",""]],hostAttrs:[1,"mdc-fab","mat-mdc-fab-base","mat-mdc-fab"],hostVars:4,hostBindings:function(n,i){n&2&&N("mdc-fab--extended",i.extended)("mat-mdc-extended-fab",i.extended)},inputs:{extended:[2,"extended","extended",ue]},exportAs:["matButton","matAnchor"],features:[we],attrs:Hf,ngContentSelectors:wc,decls:7,vars:4,consts:[[1,"mat-mdc-button-persistent-ripple"],[1,"mdc-button__label"],[1,"mat-focus-indicator"],[1,"mat-mdc-button-touch-target"]],template:function(n,i){n&1&&(Ue(Cc),Ve(0,"span",0),z(1),ye(2,"span",1),z(3,1),Se(),z(4,2),Ve(5,"span",2)(6,"span",3)),n&2&&N("mdc-button__ripple",!i._isFab)("mdc-fab__ripple",i._isFab)},styles:[`.mat-mdc-fab-base {
  -webkit-user-select: none;
  user-select: none;
  position: relative;
  display: inline-flex;
